    ...
    def get_experiences_for_prediction(self, group_name, input_features, time, temporal_window):
        ...
        for i in range(time - temporal_window, time):
            if i in group.group:
                ...
                experiences.append(Experience.get_empty_experience(self.num_inputs - self.num_actions, i))
        experiences.append(Experience(input_features, -1, time))
        experiences.reverse()
        ...
        for batch_num in range(0, batch_size):
            ...
            for i in range(ind - temporal_window, ind + 1):
                if i in group.group:
                    ...
                    experiences.append(Experience.get_empty_experience(num_inputs - num_actions, i))
            experiences.reverse()
